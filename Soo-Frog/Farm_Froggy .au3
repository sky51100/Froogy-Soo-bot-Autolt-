...
DoStep(3, 17666, 8087, "aggro")
DoStep(4, 16566, 8348, "aggro")
DoStep(5, 15272, 8352, "aggro")
DoStep(6, 13896, 7946, "aggro")
DoStep(7, 12482, 7082, "aggro")
DoStep(8, 11110, 6693, "aggro")
DoStep(9, 10439, 7643, "aggro")
DoStep(10, 9923, 8545, "aggro")
DoStep(11, 9715, 7454, "aggro")
DoStep(12, 8362, 6900, "aggro")
DoStep(13, 7847, 7881, "aggro")
DoStep(14, 7025, 6945, "aggro")
DoStep(15, 7662, 6016, "aggro")
DoStep(16, 6404, 5006, "aggro")
DoStep(17, 5750, 3860, "aggro")
DoStep(18, 5083, 2155, "aggro")
Out("Getting Dwarven Blessing")
Sleep(1000)
Agent_GoNPC(GetNearestNPCToAgent(-2))
DoStep(19, 4236, 1484, "aggro")
DoStep(20, 2698, 724, "aggro")
DoStep(21, 1243, -65, "aggro")
Sleep(7000)
Out("Attente du groupe")
DoStep(22, 345, -1485, "aggro")
DoStep(23, -458, -3024, "aggro")
DoStep(24, -525, -4092, "aggro")
DoStep(25, -1104, -5308, "aggro")
DoStep(26, -641, -6726, "aggro")
DoStep(27, -586.44, -7221, "aggro")
DoStep(28, -99.85, -8510, "aggro")
DoStep(29, -1547, -8696, "aggro")
Out("Getting Dwarven Blessing")
Sleep(1000)
Agent_GoNPC(GetNearestNPCToAgent(-2))
DoStep(30, -99.85, -8510, "aggro")
DoStep(31, 922, -9647, "aggro")
DoStep(32, 1868, -10647, "aggro")
DoStep(33, 1645, -11810, "aggro")
DoStep(34, 1207, -13385, "aggro")
DoStep(35, 1238, -14841, "aggro")
DoStep(36, 2870, -15402, "aggro")
DoStep(37, 4398, -16213, "aggro")
DoStep(38, 6041, -16748, "aggro")
DoStep(39, 7017, -17023, "aggro")
DoStep(40, 7217, -17723, "aggro")
MoveTo(7865, -19350)
