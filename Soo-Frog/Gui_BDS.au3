...
Global Const $mainGui =             GUICreate("Sky BDS Farmer", 388, 500, 191, 124)
...
Global Const $PconsBox =            GUICtrlCreateCheckbox("Conset Stage 1", 230, 64, 119, 25)
                                    GUICtrlSetFont(-1, 10, 400, 0, "Times New Roman")
									GUICtrlSetState(-1, $gui_checked)
Global Const $PconsBox2 =            GUICtrlCreateCheckbox("Conset Stage 2/3", 230, 92, 119, 25)
                                    GUICtrlSetFont(-1, 10, 400, 0, "Times New Roman")
									GUICtrlSetState(-1, $gui_checked)   
...
Global Const $Summon1 =            GUICtrlCreateCheckbox("Stage 1", 20, 135, 200, 20)
                                    GUICtrlSetFont(-1, 10, 400, 0, "Times New Roman")
									GUICtrlSetState(-1, $gui_checked)
Global Const $Summon2 =            GUICtrlCreateCheckbox("Stage 2/3", 230, 135, 200, 20)
                                    GUICtrlSetFont(-1, 10, 400, 0, "Times New Roman")
									GUICtrlSetState(-1, $gui_checked)    
...
;                                    GUICtrlSetFont(-1, 8, 800, 0, "Times New Roman")
Global Const $BDSLabel =     GUICtrlCreateLabel("BDS: " & $BDSGained, 148, 208, 200, 18)
                                    GUICtrlSetFont(-1, 8, 800, 0, "Times New Roman")
